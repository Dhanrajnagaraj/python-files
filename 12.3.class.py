...
if (len(a1) == len(b1)):
    ...
    if (a1_len >b1_len):
        print ("Length of {0} is {1}\n Length of {2} is {3}".format(a1,a1_len,b1,b1_len))
        c1_a1_gre=a1_len-b1_len
        print ("Count fo items missing in {0} is {1}".format(b1,c1_a1_gre))
    elif (b1_len > a1_len):
        print("Length of {0} is {1}\n Length of {2} is {3}".format(a1, a1_len, b1, b1_len))
        c1_b1_gre=b1_len-a1_len
        print ("Count fo items missing in {0} is {1}".format(a1,c1_b1_gre))